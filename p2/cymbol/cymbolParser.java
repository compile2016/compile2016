...
public class cymbolParser extends Parser {
	...
	public static final int
		RULE_cymbol = 0, RULE_varDecl = 1, RULE_type = 2, RULE_functionDecl = 3, 
		RULE_formalParameters = 4, RULE_formalParamenter = 5, RULE_block = 6, 
		RULE_stat = 7, RULE_expr = 8, RULE_exprList = 9;
	public static final String[] ruleNames = {
		"cymbol", "varDecl", "type", "functionDecl", "formalParameters", "formalParamenter", 
	...
	public static class CymbolContext extends ParserRuleContext {
		...
		public CymbolContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_cymbol; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof cymbolListener ) ((cymbolListener)listener).enterCymbol(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof cymbolListener ) ((cymbolListener)listener).exitCymbol(this);
		}
	}

	public final CymbolContext cymbol() throws RecognitionException {
		CymbolContext _localctx = new CymbolContext(_ctx, getState());
		enterRule(_localctx, 0, RULE_cymbol);
		int _la;
		try {
	...
	public static class FormalParametersContext extends ParserRuleContext {
		public List<FormalParamenterContext> formalParamenter() {
			return getRuleContexts(FormalParamenterContext.class);
		}
		public FormalParamenterContext formalParamenter(int i) {
			return getRuleContext(FormalParamenterContext.class,i);
		}
	...
	public static class FormalParamenterContext extends ParserRuleContext {
		public TypeContext type() {
			return getRuleContext(TypeContext.class,0);
		}
		public TerminalNode ID() { return getToken(cymbolParser.ID, 0); }
		public FormalParamenterContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_formalParamenter; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof cymbolListener ) ((cymbolListener)listener).enterFormalParamenter(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof cymbolListener ) ((cymbolListener)listener).exitFormalParamenter(this);
		}
	}

	public final FormalParamenterContext formalParamenter() throws RecognitionException {
		FormalParamenterContext _localctx = new FormalParamenterContext(_ctx, getState());
		enterRule(_localctx, 10, RULE_formalParamenter);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(53);
	...
	public static final String _serializedATN =
		...
		"\22\24\2\4\3\2\5\7\4\2\23\23\26\26\u0098\2\30\3\2\2\2\4\34\3\2\2\2\6$"+
		...
		"\2]^\7\23\2\2^n\5\22\n\n_`\7\24\2\2`n\5\22\n\tab\7\30\2\2bd\7\b\2\2ce"+
		"\5\24\13\2dc\3\2\2\2de\3\2\2\2ef\3\2\2\2fn\7\t\2\2gn\7\30\2\2hn\7\31\2"+
		"\2ij\7\b\2\2jk\5\22\n\2kl\7\t\2\2ln\3\2\2\2m\\\3\2\2\2m_\3\2\2\2ma\3\2"+
